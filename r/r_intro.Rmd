...
All of you should have gone through the Python prep seciton by now and should be ready to start the R prep section. This section is designed to help you get familiar with the R programming language.
...
1. **Numeric** - This is the most common data type in R and is used to store numbers. Numeric data types can be integers (whole numbers) or floats (numebrs with a decimal).
