...
consumables_cpi <- select(cpi_t, "Year", "Gasoline", "Energy", "Food",
                          "Alcohol_tobacco_cannabis")

durables_cpi <- select(cpi_t, "Year", "Household_operations_furniture_equipment", 
...
```{r}
ggplot(data = food_cpi_mutate) +
  geom_line(mapping = aes(x = Year, y = All_items_but_food_energy, 
                color = "All_items_but_food_energy")) +
  geom_line(mapping = aes(x = Year, y = Food, color = "Food")) +
  geom_vline(xintercept = 2020) +
  labs(title = "Exercise 1: CPI with Vline",
       x = "Year", y = "CPI") +
  scale_color_manual(values = c("blue", "red"),
                     labels = c("All-items", "Food"),
                     name = "Data Series:")
...
ggplot(data = durables_cpi) + 
  ...
  labs(title = "Exercise 2: Durable Good CPIs",
       x = "Year", y = "CPI") + 
  scale_color_manual(values = c("blue", "red", "black", "green", "purple"),
...
ggplot(data = averaged_cpi) +
  ...
  labs(title = "Exercise 3: Averaged Durable VS Service CPIs",
       x = "Year", y = "CPI") + 
  scale_color_manual(values = c("blue", "red"),
